...
def generate_feature_array(feature_array, roommate_preference):
...
def update_feature_weight(user_list, roommate_preference, user_likes, user_dislikes, feature_weight):
    ...
    for curr_user in user_list:
        ...
        for other_user in user_likes[curr_user]:
            ...
            generate_feature_array(feature_array, roommate_preference)
